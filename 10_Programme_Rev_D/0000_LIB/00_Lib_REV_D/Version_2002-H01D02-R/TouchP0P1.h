...
*  @date     15.11.14 /17.9.2017  
*  @version  1.1D   // D= HardwareVersion für Display (D= ILI9341)     
*  @todo    -
*  @see 
...
#define dMCB32_LibVersion "1738-H01D02-R"        // 1738-H01D02-R = 17.09.2017 / Bugfix in ClearScreen()
...
void TimerInitHr(char Nr, int Time10us, char IRQPrio);	  // new 10.1.2020 with 10us Resolution
