...
default startup file provided by RVMDK when creating new projects.
 ...
 - In the build toolbar select the project config:
     - ET-STM32F-ARM-KIT: to configure the project for STM32 Connectivity line devices
     @note The needed define symbols for this config are already declared in the
           preprocessor section: USE_STDPERIPH_DRIVER, STM32F10X_CL, USE_STM32F_ARM_KIT
