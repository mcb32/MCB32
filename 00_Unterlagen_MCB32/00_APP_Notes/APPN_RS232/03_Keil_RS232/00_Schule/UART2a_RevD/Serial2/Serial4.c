...
char ADC_TP(unsigned char nmal);       // Lies ADC n mal und bilde Mittelwert (TP-Mittelwertfilter)
char* Dez_Hex (unsigned char d);       // Wandle DEZ in Hex für transfer
void Ready_Sequenz(void);              // Sende Ready Sequenz nach Reset
//=================================main()======================================= //---------------------------------------------------
...
// Sende Ready Sequenz nach Reset
