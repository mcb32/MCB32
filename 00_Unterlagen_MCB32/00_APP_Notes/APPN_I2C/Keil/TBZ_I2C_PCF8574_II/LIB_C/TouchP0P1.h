...
// Version: 1.2 17.9.2017 rma Bugfix for Clearscreen
//------------------------------------------------------
...
//  -  Enthält die Pin-Definitionen und das Bitbanding zum 8 Bit P0/P1- 
//     Handling als Uebergangsstufe vom 8Bit-uC auf den 32Bit-uC.
//  -  Enthält zudem die Header zu den Funktionen zur Darstellung und 
...
#define dMCB32_LibVersion "1738-H01C02-R"        // 1738-H01C02-R = 17.09.2017 / Bugfix in ClearScreen()

// Touch enthält den Eingabezustand der Bits vom Display um mit der
// physischen Porteingabe AND-verknüpft zu werden
extern unsigned char TouchP0[8], TouchAllP0;// = {1,1,1,1,1,1,1,1};
// ----------- Bit Banding für read/write auf gleichen Bezeichner -----
...
/*
// In dieser Variante nicht mit dem Touchdisplay verknüpft
...
*/
// In dieser Variante mit dem Touchdisplay verknüpft
// BZU-Kompatibiltaet zu 1Bit Manipulation: P0_0 .. P0_7 Input von GPIOC0..7
// Alternativ zu P0_x sind die näheren Pinbezeichner PC_x verwendbar
...
// In dieser Variante mit dem Touchdisplay verknüpft
// Alternativ zu P1_0..7 sind die HW-näheren Pinbezeichner PE_8..15 verwendbar
...
#define PD_High (*((volatile unsigned char *)(&(GPIOD->IDR))+1)) // In Bit8..15 als Byte für CtrlStick
...
//------ Parameterprüfung bei CMSIS Einsatz -----------
...
//  Enthält die Touchscreen Farbdefinitionen 
