...
//Define I2C Address for  PCF8574 or PCF8574A Devices					
#define PCF8574   					   0x40
#define PCF8574A_ClockSpeed    100000     			// 400 KHz 
#define PCF8574A_ADDRESS_WR	PCF8574						// Implement here the Device Address for Writing
#define PCF8574A_ADDRESS_RD (PCF8574 |0x01)		// Implement here the Device Address for Reading
